...
subprocess.run([sys.executable, "-m", "pip", "install", "--quiet",
    "lightgbm", "xgboost", "catboost", "imbalanced-learn", "shap",
    "google-cloud-bigquery", "db-dtypes"], check=True)
...
PROJECT = "project-4034cdb0-f49f-4702-bbb"
...
# Зберегти в GCS
subprocess.run(["gsutil", "cp", "submission.csv", "gs://ai_competition/output/submission.csv"])
